...
test("it should generate hashed filenames by default", async () => {
  ...
  expect(metafileContents()["test/output/example.js"]).toHaveProperty(
    "file",
    "test/output/example-4EALSENI.js",
  );
});
...
test("it should not override the hashing format if one was supplied already", async () => {
  ...
  expect(metafileContents()["test/output/example.js"]).toHaveProperty(
    "file",
    "test/output/example.LU3IRLCV.js",
  );
});
...
test("it should generate long names by default", async () => {
  ...
  expect(metafileContents()).toEqual({
    "test/output/example.js": {
      ...
      integrity:
        "sha384-nimO+qH4Z+x/Dh3OQXGSiChAPx1P9Vl2EKLZzm4Y2CO3Fop60eBAAhIMkZRee52A",
  ...
  try {
    await esbuild.build(
      buildOptions(
        ...
        {
          entryPoints: [
            "test/input/pages/home/index.js",
            "test/input/pages/about/index.js",
          ],
        },
      ),
    );
...
test("it should not throw an error if the short name has the same extension but a different basename", async () => {
  ...
  expect(metafileContents()).toEqual({
    ...
    "index.js": {
      ...
      file: "index.js",
      integrity:
        "sha384-luEqIZuCcnb7U0fDIVbzkzFJ4fY4nGdYtZskYF7EkdDuHfyddSxA9nsZ5yRfVMZX",
...
test("it should not throw an error if the entrypoints have the same name, different extensions, and the useEntrypointKeys option is used", async () => {
  await esbuild.build(
    buildOptions(
      ...
      },
      {
        entryPoints: [
          "test/input/pages/home/index.js",
          "test/input/pages/about/index.ts",
        ],
      },
    ),
  );
  ...
  expect(metafileContents()).toEqual({
    ...
    "index.ts": {
      ...
      file: "index.js",
      integrity:
        "sha384-GMGz1u+Jvx0Rn1hjMugiN0OkJkBrp7jFRPjj1BHz7XGw2LSb/fuYI4gozZXmVmId",
...
test("it should use the same directory as the outfile if no outdir was given", async () => {
  await esbuild.build(
    buildOptions({}, { outdir: undefined, outfile: "test/output/out.js" }),
  );
...
test("it should throw an error if building without an outdir or outfile", async () => {
  ...
  try {
    await esbuild.build(
      buildOptions({}, { outdir: undefined, outfile: undefined }),
    );
  } catch (e) {
...
test("it should allow multiple entrypoints with same css", async () => {
  await esbuild.build(
    buildOptions(
      ...
      {
        entryPoints: [
          "test/input/example-with-css/example.js",
          "test/input/example-with-css/example2.js",
        ],
      },
    ),
  );
  ...
  expect(metafileContents()).toEqual({
    "test/output/example.css": {
      ...
      integrity:
        "sha384-az72to4rJ+UHsi96ok0AiWeFPEL974GZLzlmg0P1gGVQSVyZTLfyyXUmioJH6T3y",
    ...
    "test/output/example.js": {
      ...
      file: "test/output/example.js",
      integrity:
        "sha384-l6rghg35AvNTqd3kT2dfOVNgsV2VEB+SNJ9extTZVqbUh2pLS2O8uIRRkmPDPSlt",
      source: "test/output/example.js",
    },
    ...
    "test/output/example2.js": {
      ...
      integrity:
        "sha384-jiNBByEeQp22pe5wSvB8XwdND1J56+RqJz8NT7YIXnp5xWLWuY73o4H3j0dhEG1U",
...
test("it should map a sibling css file when the standard hash is used", async () => {
  ...
  expect(contents["test/output/example.js"]).toHaveProperty(
    "file",
    "test/output/example-NJWZG5S4.js",
  );
  expect(contents["test/output/example.css"]).toHaveProperty(
    "file",
    "test/output/example-PYM4QSLI.css",
  );
});
...
test("it should map a sibling css file when a different hash is used", async () => {
  ...
  expect(contents["test/output/example.js"]).toHaveProperty(
    "file",
    "test/output/example.GKFWWQKW.js",
  );
  expect(contents["test/output/example.css"]).toHaveProperty(
    "file",
    "test/output/example.Y6EEL3QK.css",
  );
});
...
test("it should map a sibling css file when the hash runs up directly against the filename", async () => {
  ...
  expect(contents["test/output/example.js"]).toHaveProperty(
    "file",
    "test/output/exampleSVNZSNZX.js",
  );
  expect(contents["test/output/example.css"]).toHaveProperty(
    "file",
    "test/output/exampleLP3NES34.css",
  );
});
    ...
    await esbuild.build(
      buildOptions(
        {},
        {
          entryPoints: [
            "test/input/example-with-css/example.js",
            "test/input/example-with-css/example.css",
          ],
        },
      ),
    );
...
test("it should not attempt to find a sibling for a css entrypoint ", async () => {
  await esbuild.build(
    buildOptions(
      {},
      { entryPoints: ["test/input/example-with-css/global.css"] },
    ),
  );
...
test("it should map typescript files", async () => {
  await esbuild.build(
    buildOptions({ hash: false }, { entryPoints: ["test/input/example.ts"] }),
  );
  ...
  expect(metafileContents()).toEqual({
    "test/output/example.js": {
      ...
      file: "test/output/example.js",
      integrity:
        "sha384-PwSfbcBNuu0ZpIl9rxo+XSHmWk6iztuO8iZpkvXtMDwhc9+CuTnKYS6JIuWlYBN5",
      source: "test/output/example.js",
    },
  });
});
...
test("it should map typescript files that import css", async () => {
  await esbuild.build(
    buildOptions(
      { hash: false },
      { entryPoints: ["test/input/example-with-css/example-typescript.ts"] },
    ),
  );
  ...
  expect(metafileContents()).toEqual({
    "test/output/example-typescript.css": {
      ...
      integrity:
        "sha384-oauGpxKpeTGp8YcjhX2S+025hwtt3IfvDoDLsYGYT4hBADaX8H58dbMFja9nTIHD",
    ...
    "test/output/example-typescript.js": {
      ...
      integrity:
        "sha384-JyJ0kfvSVYC3+PO6G9z66FQ4pw1/EC/mQqn4kCOa4+XAdntrVUWrVgNSwBOKXkAi",
...
test("it should include an imported image file that is not an explicit entrypoint", async () => {
  ...
  expect(contents["test/output/example.js"]).toEqual({
    ...
    integrity:
      "sha384-EaCB1WpRRlkiRaou2UbTw2gINEZJelMPYRzdDa9q9QKGjXpzmZjiI+S1z82uFe/m",
    source: "test/output/example.js",
  });
  expect(contents["test/output/example.png"]).toEqual({
    ...
    integrity:
      "sha384-RCAoIWtw46cYknOSs7fjnkvHvA/KAXGw0Q8UGXheWn2kV8jdArT+MR7lBCnE0L+V",
...
test("it should include an imported image file that is not an explicit entrypoint (hash=false)", async () => {
  ...
  expect(metafileContents()).toEqual({
    "test/output/example.js": {
      ...
      file: "test/output/example.js",
      integrity:
        "sha384-voTRTPaSfv4RhasFOIVYPJ+t4EH6mOzaRnXyd0TaKtkw9bO33hPgx/xdZxXzUDxO",
      source: "test/output/example.js",
    },
...
test("it should include assets placed inside their own directory within the outdir", async () => {
  ...
  expect(contents["test/output/example.js"]).toEqual({
    ...
    integrity:
      "sha384-pXWfV0GbaLDOhodjy0B/2pzOJc/6u2WYHWw5sb2/q4UK7sOKVH/kfybKxErhSimG",
    source: "test/output/example.js",
  });
...
test("it should throw an error if the extensionless option is used with bundled css", async () => {
  ...
  try {
    ...
    expect(e.message).toMatch(
      /conflicting manifest key.+example\.js.+example\.css/,
    );
  }
});
...
test("it should allow an extensionless input with shortnames", async () => {
  await esbuild.build(
    buildOptions({ hash: false, shortNames: true, extensionless: "input" }),
  );
...
test("it should allow an extensionless output with shortnames", async () => {
  await esbuild.build(
    buildOptions({ hash: false, shortNames: true, extensionless: "output" }),
  );
...
test.each([
  ...
  },
  {
    ...
    expected: {
      "test/output/example": {
        ...
        file: "test/output/example.js",
        integrity:
          "sha384-9NYoCOTZw3WxlghTilfFv7PZSiuzo3Nf2FzlTXKogkNGrbY/z4b04Btr9FhMJwo2",
        source: "test/output/example.js",
      },
      "test/output/example.map": {
        ...
        integrity:
          "sha384-RzL2RVcj6qFV4vzIkN1FZyaVOsEkYmp3kYo3VuLp7tArB1lDm4JmlvTLtk58DfNV",
  ...
  "it should allow the extensionless option on a file with multiple extensions",
  async (options) => {
    await esbuild.build(
      buildOptions(
        {
...
test("it should include the manifest file as part of the build result output files with the esbuild write=false option", async () => {
  const result = await esbuild.build(
    buildOptions({ hash: false }, { write: false }),
  );
  ...
  const expectedOuput = {
    "test/output/example.js": {
      ...
      integrity:
        "sha384-/C84a5gTs27+9oa3Gr1HfuQ5tz7IPGZpI88NOiBJtiygOsxHUA/ytMn97r+OOs1J",
    },
  };
...
test("it should only generate the manifest when the build result contains no errors", async () => {
  try {
    await esbuild.build(
      buildOptions({}, { entryPoints: ["test/input/example-with-error.js"] }),
    );
  } catch (e) {
...
test("it should use the same extension as the output when it is changed via the esbuild outExtension option", async () => {
  await esbuild.build(
    buildOptions({ hash: false }, { outExtension: { ".js": ".mjs" } }),
  );
...
test("it should use the hashed filename of chunks as keys when splitting is enabled", async () => {
  await esbuild.build(
    buildOptions(
      ...
      {
        entryPoints: [
          "test/input/splitting/index.js",
          "test/input/splitting/home.js",
          "test/input/splitting/about.js",
        ],
        splitting: true,
        format: "esm",
      },
  ...
  expect(contents["test/output/chunk-YJHBKB32.js"]).toEqual({
    ...
    integrity:
      "sha384-4B/PkotLJjUpXQFN5rYtHqC0Me2J6iBt3Tv9UKRx3KG5j6Mr5X5s3AqoP8UFCR0l",
  ...
  expect(contents["test/output/chunk-CGERAYKX.js"]).toEqual({
    ...
    integrity:
      "sha384-dpcsqKCEcpcoFjMdaxSOmLaLEwf5+/JBgUClpN3jnpq1vyMU15p3YePEI+MIJPsk",
